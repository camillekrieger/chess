...
public class WebSocketService {
    ...
    private ServerMessage a(ChessGame.TeamColor p,ChessGame.TeamColor c,GameData g,ChessMove m,int id)throws InvalidMoveException,DataAccessException{
        if(p.equals(c)) {
    ...
    public ServerMessage makeMove(int gameID, String authToken, ChessMove move) throws DataAccessException, InvalidMoveException {
        ...
        if (authData != null){
            ...
            if (gameData != null) {
                ...
                return a(player, currTurn, gameData, move, gameID);
            }
            else{
                return new ErrorMessage(ServerMessage.ServerMessageType.ERROR, "invalid game id.");
            }
